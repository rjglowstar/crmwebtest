...
import { BidingResultRoutingModule } from './bidingResult-routing.module';
import { BidingDetailsModule } from '../bidingDetails/bidingDetails.module';


@NgModule({
  declarations: [BidingResultComponent],
  imports: [
    CommonModule,
    BidingResultRoutingModule,
    IndicatorsModule,
...
export class BidingResultModule { }