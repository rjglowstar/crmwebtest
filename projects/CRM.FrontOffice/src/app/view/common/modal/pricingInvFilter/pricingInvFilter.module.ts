...
import { PricingInvFilterComponent } from "./pricingInvFilter.component";
...
@NgModule({
  ...
  declarations: [PricingInvFilterComponent],
  exports: [PricingInvFilterComponent],
...
export class PricingInvFilterModule { }