...
import { ExpoCustRegisterRoutingModule } from './expoCustRegister-routing.module';
import { ExpoCustRegisterComponent } from './expoCustRegister.component';

@NgModule({
  declarations: [ExpoCustRegisterComponent],
  imports: [
    CommonModule,
    ExpoCustRegisterRoutingModule,
    LayoutModule,
    InputsModule,
    DialogsModule,
    FormsModule,
  ...
  providers: [CustomerVerificationService,
    ...
    AlertdialogService,
    CommonService],
  exports: [ExpoCustRegisterComponent]
})
export class ExpoCustRegisterModule { }