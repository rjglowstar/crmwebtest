...
import { CutDetailDNorm, FancyCutDetailDNorm, GirdlePerDetailDnorm, MasterConfig, MasterConfigType, MasterDNorm } from 'shared/enitites';
...
export class MasterConfigService {
    ...
    async insertGirdlePerDetails(girdlePerDetail: GirdlePerDetailDnorm): Promise<boolean> {
        const post$ = this.http.post(keys.apiUrl + this.controllerPath + "InsertGirdlePerDetail", girdlePerDetail);
    ...
    async updateGirdlePer(data: GirdlePerDetailDnorm): Promise<boolean> {
        const put$ = this.http.put(keys.apiUrl + this.controllerPath + "UpdateGirdlePer", data);
    ...
    async deleteGirdlePerDetails(girdlePerDetailsId: string): Promise<boolean> {
        const delete$ = this.http.delete(keys.apiUrl + this.controllerPath + "DeleteGirdlePerDetails/" + girdlePerDetailsId);
