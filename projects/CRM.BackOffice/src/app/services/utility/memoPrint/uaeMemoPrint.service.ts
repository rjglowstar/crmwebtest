    ...
    public async getMemoPrint(memoObj: Memo, memoType: string) {
        ...
        if (memoType == "UAELOCAL") {
          ...
          <div class="chal-wrap con-inv di-inv">
            <div class="chal-head">
              <div class="logo">
                <img src="assets/billimage/diamoondmcc.png" alt="logo">
              </div>
            ...
            <span class="c-st border-left-2 border-right-2 border-bottom-2">ON APPROVAL</span>
              <div class="body-top ps-1 border-bottom-0">
                ...
                <div class="di-bor-0" style="padding-right:10px;">
                <table>
                  <tbody>
                    <tr>
                      <td style="text-align:right;"><b>APPROVAL NO. : </b></td>
        ...
        <div class="body-middle">
          `
            ...
            <tbody>`
                    ...
                    for (let index = memoObj.inventoryItems.length; index < 16; index++) {
                        htmlString += `
                  <tr>
                  <td>&nbsp</td>               
                  <td></td>
            ...
            <tr>
              ...
              <div class="body-f-footer sign-box">  
              <div class="border-right-2">
                  <span class="c-st di" style="font-size:13px;">Seller Confirmation</span>
                  <div class="ch-sig">
                  <span>&nbsp</span>
                  <span>&nbsp</span>
                  <span>&nbsp</span>
